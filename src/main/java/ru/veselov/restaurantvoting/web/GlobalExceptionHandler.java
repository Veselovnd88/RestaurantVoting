...
public class GlobalExceptionHandler {
    ...
    public static final String VOTE_PER_DAY = "user_day_idx";
    ...
    public static final String VOTE_FOR_TODAY_EXISTS = "Vote for this date already exists";
    ...
    public static final Map<String, String> CONSTRAINTS_MAP = Map.of(
            ...
            VOTE_PER_DAY, VOTE_FOR_TODAY_EXISTS
    );
